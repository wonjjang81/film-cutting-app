...
export default function EstimateScreen() {
  ...
  const estimatePanels = getEstimatePanelVisibility(estimateJobs.length > 0);
...
const styles = StyleSheet.create({
  ...
  currentHint: { marginTop: 6, fontSize: 11, lineHeight: 17, color: '#64748b' }, disabledButton: { opacity: 0.45 },
});
