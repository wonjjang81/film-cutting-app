...
export default function EstimateScreen() {
  ...
  const projectEstimate = calculateProjectEstimate(jobs, materialCost, constructionCost, discountOverride);
  const exportEstimatePdf = async () => {
    if (jobs.length === 0) return;
    const html = createEstimateHtml(jobs, projectEstimate, materialCost, constructionCost, company);
