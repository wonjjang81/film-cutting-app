...
export default function ProjectsScreen() {
  ...
  return <ScrollView style={styles.page} contentContainerStyle={styles.content}>
    ...
    <View style={styles.projectActions}><TouchableOpacity accessibilityRole="button" accessibilityLabel="프로젝트 저장" onPress={() => void saveCurrentEstimate()} disabled={busy} style={[styles.actionPrimary, busy && styles.disabled]}><Text style={styles.actionPrimaryText}>프로젝트 저장</Text></TouchableOpacity><TouchableOpacity accessibilityRole="button" accessibilityLabel="프로젝트 JSON 가져오기" onPress={() => void importProject()} disabled={busy} style={[styles.actionSecondary, busy && styles.disabled]}><Text style={styles.actionSecondaryText}>프로젝트 가져오기</Text></TouchableOpacity><TouchableOpacity accessibilityRole="button" accessibilityLabel="전체 프로젝트 백업 내보내기" onPress={() => void exportLibrary()} disabled={busy} style={[styles.actionSecondary, busy && styles.disabled]}><Text style={styles.actionSecondaryText}>백업 내보내기</Text></TouchableOpacity><TouchableOpacity accessibilityRole="button" accessibilityLabel="전체 프로젝트 백업 불러오기" onPress={() => void importLibrary()} disabled={busy} style={[styles.actionSecondary, busy && styles.disabled]}><Text style={styles.actionSecondaryText}>백업 불러오기</Text></TouchableOpacity></View>
